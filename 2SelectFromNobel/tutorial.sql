--1
--Display year, subject and winner of Nobel prizes for 1950
SELECT 
    yr, subject, winner
FROM 
    nobel
...
--2
--Show who won the 1962 Nobel prize for literature
SELECT
    winner
FROM
    nobel
...
FROM 
    nobel
WHERE
    subject = 'peace' AND winner IN('Theodore Roosevelt', 'Thomas Woodrow Wilson', 'Jimmy Carter', 'Barack Obama' )
